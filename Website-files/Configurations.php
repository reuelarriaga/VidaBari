...
ParseClient::initialize(
	...
	'BicVzbD6ETAKk0IVmwzCZYwAuz5pqEWfI2T9YO6D', 
	
	// REPLACE THIS STRING WITH YOUR OWN 'REST API Key' FROM back4app
	'nLeKhkN3EB8N5XscahMPvQEsn4TIKVeiOXhLc31X', 

	// REPLACE THIS STRING WITH YOUR OWN 'Master Key' FROM back4app
	'ffRFUBfHtFon6UftZsimsaLnVRcMGyAyvO6Vjwlr' 
...
// ------------------------------------------------
$DEFAULT_LOCATION_LATITUDE = 40.7143528;
$DEFAULT_LOCATION_LONGITUDE = -74.0059731;

// ------------------------------------------------
// IMPORTANT: REPLACE THE STRING BELOW WITH THE FULL URL OF THE ROOT OF YOUR WEBSITE: 
// ------------------------------------------------
$WEBSITE_PATH = "http://voe.legacyteen.com/vidabari/Website-files/";
