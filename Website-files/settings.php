...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar fixed-top">
      ...
      <!-- title header -->
      <div class="title-header">Configurações</div>
      <!-- right menu button -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <img id="avatarImg" class="center-cropped-40" style="margin-right: 10px;" src="<?php echo $avatarURL; ?>"> Foto
                <a data-toggle="modal" href="#uploadImageModal" class="btn" style="float: right">Alterar</a>
                ...
                <input type="text" id="email" class="settings-input" placeholder="Endereço de e-mail" value="<?php echo $email ?>">
            	</div>
                <br><br><div class="separator"></div>
                ...
                <br><br>
                <div class="text-center"><a href="#" class="btn btn-primary" style="width: 280px" onclick="updateProfile()">Atualizar perfil</a></div>
                <!-- logout button -->
                <br>
                <div class="text-center"><a href="logout.php" class="btn btn-logout">Sair</a></div>
